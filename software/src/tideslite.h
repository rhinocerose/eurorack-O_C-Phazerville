...
constexpr int16_t wav_bipolar_fold[]
...
constexpr int16_t wav_unipolar_fold[] = {
...
// 12 * 128 -> 16.35Hz = C0
// ...
// 12 * 128 * 10 = 15360 -> 8372Hz = C11
constexpr uint32_t ComputePhaseIncrement(int16_t pitch) {
...
constexpr int16_t ComputePitch(uint32_t phase_increment) {
